package com.gaarx.iptvplayer.core.ytlivedashmanifestparser;

import android.net.Uri;
import android.util.Log;

import com.gaarx.iptvplayer.core.ytlivedashmanifestparser.querystringparser.UrlQueryString;
import com.gaarx.iptvplayer.core.ytlivedashmanifestparser.querystringparser.UrlQueryStringFactory;
...
public class LiveDashManifestParser extends DashManifestParser {
    ...
    private static class MultiSegmentRepresentationWrapper extends MultiSegmentRepresentation {
        ...
        public MultiSegmentRepresentationWrapper(
            ...
            super(revisionId, format, baseUrls, segmentBase, inbandEventStreams, new ArrayList<>(), new ArrayList<>());
        }
